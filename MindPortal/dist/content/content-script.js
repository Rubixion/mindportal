...
function showOverlay(domain, mode, countdownSeconds, userName) {
  ...
  if (mode === "block") {
    ...
    const countdownId2 = "ff-countdown-num";
  ...
  function handleContinue(domain2) {
    const dismissCheckbox = document.getElementById("ff-dismiss-today");
    if (dismissCheckbox?.checked) {
      chrome.runtime.sendMessage({ type: "DISMISS_SITE_TODAY", domain: domain2 });
    }
    removeOverlay();
  }
